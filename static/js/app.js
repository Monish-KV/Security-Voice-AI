...
function renderResult(result) {
  ...
  $("#classification-label").textContent = result.classification || "—";
  $("#classification-label").style.color = result.classification === "FAKE" ? "var(--red)" : "var(--teal)";
  $("#classification-reason").textContent = result.classification_reason || "No classification explanation returned.";
  $("#alert-email").textContent = result.alert_status?.email || "NOT REQUIRED";
  $("#alert-sms").textContent = result.alert_status?.sms || "NOT REQUIRED";
